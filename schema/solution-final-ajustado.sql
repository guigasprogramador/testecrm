-- SCRIPT FINAL AJUSTADO PARA RESOLVER OS PROBLEMAS DO SUPABASE
-- Execute este script na íntegra no SQL Editor do Supabase
-- Ajustado para verificar a existência de objetos antes de criá-los

-- 1. REMOVER A RESTRIÇÃO PROBLEMÁTICA DE CHAVE ESTRANGEIRA
ALTER TABLE crmonefactory.users 
DROP CONSTRAINT IF EXISTS users_id_fkey;

-- 2. RECRIAR A TABELA USERS COM A ESTRUTURA CORRETA
